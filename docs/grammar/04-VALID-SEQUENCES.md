...
**Notes:**
- All transitions must still satisfy U1-U5 constraints
...
- Deep REMESH needs scale stabilizers IL/THOL (U5)
...
This section documents the precise algorithms used to validate U1-U5 constraints. This is the canonical implementation that matches `tnfr.operators.grammar.validate_grammar()`.
