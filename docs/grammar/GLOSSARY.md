...
### Grammar
**Definition:** Set of rules (U1-U4) governing valid operator sequences.

**Purpose:** Ensure sequences respect TNFR physics.

**Components:** U1 (INITIATION & CLOSURE), U2 (CONVERGENCE), U3 (COUPLING), U4 (BIFURCATION)
...
**Validation:** Must satisfy U1-U4 constraints.
