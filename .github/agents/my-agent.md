...
| **Structural research program (R1–R9)** | Nine internal lines on the arithmetic/spectral dynamics: symmetry-sector observability (R1); the arithmetic pulse recurrence `gcd(k,p−1)+1` (R2, **derived**); CRT as U5 synthesis (R3, exact Kronecker); the projective p-adic tower (R4, transport exact — **REMESH not claimed**); finite/Gaussian fields (R5, prime regression exact, detection k-sensitive); controlled additive theory (R6, additive reading **= Fourier**, constructive negative); the arithmetic-pressure audit (R7, sufficient but **primality-redundant**, completeness open); operator certification (R8, 2 certified / 4 rejected — no 14th operator); directed non-normal dynamics (R9, stable spectrum + transient amplification, U2 transient bound open). None closes an open problem. | [RESEARCH_R1_R9_HANDOFF_2026-09-05.md](theory/RESEARCH_R1_R9_HANDOFF_2026-09-05.md) |
