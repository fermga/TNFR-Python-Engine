...
class OptimizedTNFRPrimality:
    ...
    def is_prime(self, n: int) -> Tuple[bool, float]:
        ...
        self.stats["average_time"] = (
            self.stats["total_time"] / self.stats["tests_performed"]
        )
    ...
    def benchmark(self, max_n: int = 10000) -> Dict[str, Any]:
        ...
        benchmark_stats = {
            ...
            "numbers_per_second": (
                len(test_numbers) / total_time if total_time > 0 else 0
            ),
            "cache_hit_rate": (
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "memory_efficiency": (
                "Good" if len(self._delta_cache) < self.cache_size * 0.8 else "Full"
            ),
        }
...
def performance_comparison(numbers: List[int]) -> Dict[str, Any]:
    ...
    return {
        ...
        "speedup_cached_pass": (
            basic_time / opt_cached_time if opt_cached_time > 0 else 0
        ),
