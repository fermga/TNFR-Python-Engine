...
class TestFeedbackIntegration(unittest.TestCase):
    ...
    def test_factorizer_integration(self):
        ...
        performance = self.integrated_factorizer.feedback_learner.get_performance_summary()
    ...
    def test_convenience_function(self):
        ...
        integrated = create_feedback_integrated_factorizer(mock_factorizer, self.db_path)
