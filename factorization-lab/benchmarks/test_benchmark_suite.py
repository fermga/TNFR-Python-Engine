...
def test_classical_methods():
    ...
    print(
        f"Trial division 15: factors={factors}, runtime={runtime:.2f}ms, iterations={iterations}"
    )
    ...
    print(
        f"Pollard rho 15: factors={factors}, runtime={runtime:.2f}ms, iterations={iterations}"
    )
...
def test_theoretical_factors():
    ...
    test_cases = [(15, [3, 5]), (105, [3, 5, 7]), (343, [7, 7, 7]), (1001, [7, 11, 13])]
...
def run_mini_benchmark():
    ...
    for n in test_numbers:
        ...
        results.append(
            {
                ...
                "trial_division": {
                    "factors": factors_td,
                    "runtime_ms": runtime_td,
                    "success": success_td,
                },
                "pollard_rho": {
                    "factors": sorted(factors_pr),
                    "runtime_ms": runtime_pr,
                    "success": success_pr,
                },
            }
        )
        ...
        print(
            f"n={n}: TD={runtime_td:.2f}ms{'✓' if success_td else '✗'}, "
