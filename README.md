...
- 📐 **[Unified Grammar Rules](UNIFIED_GRAMMAR_RULES.md)** - U1-U5 constraint derivations (temporal + multi-scale)
...
> Update: Grammar now includes **U5 (Multi-Scale Coherence)** — ensuring hierarchical REMESH (recursivity) is stabilized (IL / THOL) to conserve coherence across nested EPIs.
