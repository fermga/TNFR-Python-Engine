...
viols207 = [json.loads(line) for line in open(BASE / 'u6_fine_i207.jsonl') if 'violate' in json.loads(line)['sequence_type']]
...
viols212 = [json.loads(line) for line in open(BASE / 'u6_hysteresis_down_i212.jsonl') if 'violate' in json.loads(line)['sequence_type']]
print('\ni212 violations:')
