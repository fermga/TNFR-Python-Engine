...
def normalizar_historial_glifos(historial_glifos_por_nodo, analizar_dinamica=False):
    glifo_codigo = {
    ...
    for nodo_id, historial in historial_glifos_por_nodo.items():
        ...
        for entrada in historial:
            ...
            # Detectar cuál es el glifo y cuál el paso
...
normalizar_historial_glifos(historial_glifos_por_nodo)
