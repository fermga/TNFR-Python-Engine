...
def experiment_1_fixed_point():
    ...
    # convergence speed
    stable_at = next((k for k in range(len(traj) - 1)
...
def experiment_2_washout():
    ...
    print()
    print(f"  {'initial topology':18s} {'init edges':>10} {'fixed edges':>12} "
          f"{'survived':>9}")
    for name, G0 in [("cycle C14", nx.cycle_graph(N)),
        ...
        print(f"  {name:18s} {G0.number_of_edges():>10} "
