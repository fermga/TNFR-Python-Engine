...
def example_cached_si_computation():
    ...
    @cache_tnfr_computation(
        ...
        dependencies={'graph_topology', 'all_node_nu_f', 'all_node_delta_nfr', 'all_node_phase'},
...
def example_selective_invalidation():
    ...
    G.add_edge(0, 10)
    print(f"   Cache entries after topology change: {sum(cache.get_stats()['entry_counts'].values())}")
