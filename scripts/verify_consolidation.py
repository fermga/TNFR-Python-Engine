...
def verify_validation_exports() -> tuple[bool, str]:
    ...
    try:
        ...
        expected = [
            ...
            'GraphCanonicalValidator', 'validate_canon',
            'coerce_glyph', 'CANON_COMPAT', 'CANON_FALLBACK',
        ]
        ...
        return True, f"✅ All {len(validation.__all__)} validators exported from tnfr.validation"
