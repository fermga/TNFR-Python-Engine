...
@pytest.mark.parametrize("settings,requested,expected", (
    ({}, None, CORE_DEFAULTS["THOL_BIFURCATION_THRESHOLD"]),
    ({"THOL_BIFURCATION_THRESHOLD": 0.4}, None, 0.4),
    ({"BIFURCATION_THRESHOLD_TAU": 0.3, "THOL_BIFURCATION_THRESHOLD": 0.4}, None, 0.3),
    ({"BIFURCATION_THRESHOLD_TAU": None, "THOL_BIFURCATION_THRESHOLD": 0.4}, None, 0.4),
    ({"BIFURCATION_THRESHOLD_TAU": 0.3, "THOL_BIFURCATION_THRESHOLD": 0.4}, 0.2, 0.2),
    ({"BIFURCATION_THRESHOLD_TAU": 0.3}, 0.0, 0.0),
    ({"THOL_BIFURCATION_THRESHOLD": 0.0}, None, 0.0),
    ({"BIFURCATION_THRESHOLD_TAU": math.nan, "THOL_BIFURCATION_THRESHOLD": "unused"}, 0.2, 0.2),
    ({"BIFURCATION_THRESHOLD_TAU": 0.3, "THOL_BIFURCATION_THRESHOLD": math.nan}, None, 0.3),
    # Irrelevant policies never substitute for the THOL-specific default.
    ({"ZHIR_BIFURCATION_THRESHOLD": 0.8, "OZ_BIFURCATION_THRESHOLD": 0.9}, None, 0.1),
))
...
@pytest.mark.parametrize("value", (True, False, "0.1", -0.1, math.inf, -math.inf, math.nan))
@pytest.mark.parametrize("location", ("requested", "BIFURCATION_THRESHOLD_TAU", "THOL_BIFURCATION_THRESHOLD"))
