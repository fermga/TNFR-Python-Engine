...
class TestDissonancePropagation:
    ...
    def test_oz_respects_phase_compatibility(self):
        ...
        assert (
            abs(dnfr_2_after - dnfr_2_before) < 0.01
        ), "Incompatible neighbor should not receive dissonance"
...
class TestNetworkDissonanceField:
    ...
    def test_field_computation_with_path_topology(self):
        ...
        assert (
            1 in field or 2 in field
        ), f"Field should include nodes within radius. Source DNFR: {source_dnfr}, Field: {field}"
    ...
    def test_field_respects_radius_limit(self):
        ...
        assert (
            1 in field_r1
        ), f"Field should include node 1. Source DNFR: {source_dnfr}, Field: {field_r1}"
