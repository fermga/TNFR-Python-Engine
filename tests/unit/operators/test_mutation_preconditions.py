...
class TestZHIRHistoryRequirements:
    ...
    def test_zhir_requires_epi_history_for_threshold(self, caplog):
        ...
        assert any(
            "without sufficient EPI history" in record.message or
    ...
    def test_zhir_with_both_history_keys(self):
        ...
        assert G1.nodes[n1].get("_zhir_threshold_met") or G1.nodes[n1].get("_zhir_threshold_warning")
        ...
        assert G2.nodes[n2].get("_zhir_threshold_met") or G2.nodes[n2].get("_zhir_threshold_warning")
...
class TestZHIRNodeValidation:
    ...
    def test_zhir_accepts_small_positive_vf(self):
        ...
        assert G.nodes[node].get("_zhir_threshold_met") or G.nodes[node].get("_zhir_threshold_warning")
