...
class TestBifurcationScore:
    ...
    def test_bifurcation_score_respects_tau_threshold(self):
        ...
        score_low_tau = compute_bifurcation_score(d2epi=d2epi, dnfr=0.3, vf=1.0, epi=0.5, tau=0.3)

        # Higher tau makes same d2epi less significant
        score_high_tau = compute_bifurcation_score(d2epi=d2epi, dnfr=0.3, vf=1.0, epi=0.5, tau=0.9)
