...
class TestMigrationChecker:
    ...
    def test_migration_report_summary(self):
        ...
        report.issues.append(
            MigrationIssue(level=IssueLevel.ERROR, message="Test error", suggestion="Fix it")
        )
...
class TestIntegration:
    ...
    def test_multiple_sequences_workflow(self):
        ...
        assert len([i for i in upgraded_report.issues if i.level == IssueLevel.ERROR]) <= len(
            [i for i in report.issues if i.level == IssueLevel.ERROR]
        )
