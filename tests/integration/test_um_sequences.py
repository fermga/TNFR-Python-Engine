...
from tnfr.operators.definitions import Coupling, Resonance, Emission, Coherence, Reception
...
class TestCanonicalUMSequences:
    ...
    def test_al_um_emission_coupling(self):
        ...
        if isinstance(epi_after_emission, (int, float)) and isinstance(
            epi_after_coupling, (int, float)
        ):
            assert epi_after_coupling == pytest.approx(
                epi_after_emission, abs=0.15
    ...
    def test_um_il_coupling_stabilization(self):
        ...
        assert (
            results_after_stabilization.coherence >= results_after_um.coherence * 0.8
    ...
    def test_network_sync_includes_um(self):
        ...
        assert (
            phase_spread_after < phase_spread_before
...
class TestUMNetworkFormation:
    ...
    def test_um_forms_coherent_network(self):
        ...
        assert results_formed.coherence > 0.5, "UM should contribute to network formation"
    ...
    def test_um_bridges_phase_groups(self):
        ...
        assert (
            phase_spread_after < phase_spread_before * 0.5
...
class TestUMStructuralInvariants:
    ...
    def test_um_preserves_epi_identity(self):
        ...
        assert epi_after == pytest.approx(
            epi_before, abs=0.15
    ...
    def test_um_modifies_phase(self):
        ...
        assert abs(theta_after - theta_before) > 0.01, "UM should synchronize phase"
    ...
    def test_um_can_reduce_dnfr(self):
        ...
        assert dnfr_after < dnfr_before, "UM with stabilization should reduce ΔNFR"
...
class TestUMTopologyEffects:
    ...
    def test_um_across_topologies(self, topology, edge_prob):
        ...
        assert results_after.coherence > 0.5, f"UM should work in {topology} topology"
    ...
    def test_um_with_disconnected_components(self):
        ...
        assert results.coherence > 0.4, "UM should synchronize within connected components"
...
class TestUMMetricsAndTracking:
    ...
    def test_um_phase_convergence_tracked(self):
        ...
        assert phase_spreads[-1] < phase_spreads[0] * 0.8, "Phase spread should reduce over time"
    ...
    def test_um_coherence_contribution(self):
        ...
        assert (
            results_after.coherence >= results_before.coherence * 0.7
