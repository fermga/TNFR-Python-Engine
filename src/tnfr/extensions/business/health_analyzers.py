...
class ProcessHealthAnalyzer:
    ...
    def analyze_process_health(
        ...
        **kwargs : Any
        ...
        metrics["change_readiness"] = self._calculate_change_readiness(
            G, sequence
        )
        metrics["alignment_strength"] = self._calculate_alignment_strength(
            G, sequence
        )
    ...
    def _calculate_change_readiness(
        self, G: nx.Graph, sequence: List[str]
    ) -> float:
    ...
    def _calculate_alignment_strength(
        self, G: nx.Graph, sequence: List[str]
    ) -> float:
