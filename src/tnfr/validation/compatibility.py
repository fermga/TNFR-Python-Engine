...
_STRUCTURAL_COMPAT: dict[str, set[str]] = {
    ...
    RECEPTION: {COHERENCE, COUPLING, RESONANCE, TRANSITION, SELF_ORGANIZATION},
    ...
    DISSONANCE: {MUTATION, TRANSITION, SELF_ORGANIZATION, CONTRACTION},
    MUTATION: {COHERENCE, TRANSITION, SILENCE},
    TRANSITION: {DISSONANCE, MUTATION, RESONANCE, COHERENCE, COUPLING, SILENCE},
    ...
    SELF_ORGANIZATION: {
        ...
        EMISSION,  # Allow internal emission within THOL
    },
}
