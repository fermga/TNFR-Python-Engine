...
__all__ = ['MathematicsBackend', 'BackendUnavailableError', 'register_backend', 'get_backend', 'available_backends', 'ensure_array', 'ensure_numpy']
...
def ensure_array(value: Any, *, dtype: Any | None = None, backend: MathematicsBackend | None = None) -> Any: ...
def ensure_numpy(value: Any, *, backend: MathematicsBackend | None = None) -> Any: ...
def register_backend(name: str, factory: BackendFactory, *, aliases: Iterable[str] | None = None, override: bool = False) -> None: ...
