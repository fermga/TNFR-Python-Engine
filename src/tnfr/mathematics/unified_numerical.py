...
class TNFRNumericalUtilities:
    ...
    def compute_phase_difference(self, phase1: ArrayLike, phase2: ArrayLike) -> ArrayLike:
        ...
        if NUMPY_AVAILABLE:
            if distribution == "uniform":
                ...
                raise TNFRValueError(
                    ...
                    context={"distribution": distribution, "supported": ["uniform", "normal", "exponential"]},
    ...
    def safe_divide(self, numerator: ArrayLike, denominator: ArrayLike, fallback: float = 0.0) -> ArrayLike:
        ...
        if NUMPY_AVAILABLE:
            ...
            return np.divide(num, den, out=np.full_like(num, fallback), where=(den != 0))
        else:
            # Fallback implementation
