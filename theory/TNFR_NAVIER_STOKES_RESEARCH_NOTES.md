...
- `examples/06_navier_stokes/77_navier_stokes_taylor_green_demo.py` — N2 demo
...
N10 (commit `1fac358b`, `examples/06_navier_stokes/85_navier_stokes_dimensional_asymmetry.py`) verified **empirically** that the discrete `TNFRNavierStokesOperator` satisfies the three structural invariants:
