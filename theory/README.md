...
| [EXTENDED_FIELDS_AND_DERIVED_QUANTITIES.md](EXTENDED_FIELDS_AND_DERIVED_QUANTITIES.md) | [33](../examples/02_physics_regimes/33_complex_field_unification.py), [unified_fields](../examples/08_emergent_geometry/unified_fields_showcase.py) | `.tensor_invariants()`, `.emergent_fields()` |
| [APPLIED_STRUCTURAL_ANALYSIS.md](APPLIED_STRUCTURAL_ANALYSIS.md) | [41](../examples/03_riemann_zeta/41_von_mangoldt_zeta_demo.py)–[43](../examples/03_riemann_zeta/43_prime_ladder_hamiltonian_demo.py) | `tnfr.riemann` |
| [TNFR_RIEMANN_RESEARCH_NOTES.md](TNFR_RIEMANN_RESEARCH_NOTES.md) | [41](../examples/03_riemann_zeta/41_von_mangoldt_zeta_demo.py)–76 (P12–P49 ζ-track + χ-twisted L-track), 78–89 (Type-Hygiene B0–B11) | `tnfr.riemann` |
| [TNFR_NAVIER_STOKES_RESEARCH_NOTES.md](TNFR_NAVIER_STOKES_RESEARCH_NOTES.md) | [158](../examples/06_navier_stokes/158_navier_stokes_two_face_refounded.py) (two-face reading + nonlinear K_φ cascade frontier) | `tnfr.navier_stokes` |
...
4. [TNFR_RIEMANN_RESEARCH_NOTES.md](TNFR_RIEMANN_RESEARCH_NOTES.md) — Riemann program → [example 41](../examples/03_riemann_zeta/41_von_mangoldt_zeta_demo.py)
...
- **Factorization**: [APPLIED_STRUCTURAL_ANALYSIS.md](APPLIED_STRUCTURAL_ANALYSIS.md) → [examples 41–43](../examples/03_riemann_zeta/41_von_mangoldt_zeta_demo.py)
